    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-charcoal/98 backdrop-blur-sm shadow-dark py-2'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8">
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-sm font-medium tracking-wide transition-colors hover:text-gold-400 ${
                    pathname === link.href ? 'text-gold-400' : 'text-champagne/90'
                  }`}
                >
                  {link.label}
                </Link>
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-6 py-2.5 bg-gold-500 text-charcoal text-sm font-medium tracking-wide rounded-sm hover:bg-gold-400 transition-all shadow-gold hover:shadow-elegant focus-visible:outline-2 focus-visible:outline-gold-400 focus-visible:outline-offset-2"
              >
                Book Now
              </Link>
            </nav>
            ...
            <button
              ...
              className="md:hidden text-champagne focus-visible:outline-2 focus-visible:outline-gold-400 focus-visible:outline-offset-2 p-2 rounded-sm"
